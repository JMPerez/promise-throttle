 ...
 * @param {String} eventName Name of the event to listen valid values: ['queueSizeChange']
 * @param {Function} callback A function returning the promise to be added
 * @return {void}
 */
PromiseThrottle.prototype.on = function(eventName, callback) {
...
PromiseThrottle.prototype._execute = function() {
  ...
  this.eventEmitter.emit('queueSizeChanged', this.queued.length);
  if (aborted) {
